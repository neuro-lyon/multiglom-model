...
"""
Analysis of *bigruns*, that is a set of simulations.
This script analyses bigruns where two parameters were changed:

- inter-population connection rate
- inter-population connection strength
...
2. Get the common attributes of the simulations (number of mitral cells, etc.)
3. Get the value and plot the following index given the inter-population
   connection strength and rate :

   - MPS
   - STS
   - FFT max
   - Spiking rate (with inter/intra-population differentiation)
   - Peak distances

4. Finally, close the HDF5 file and plot every figure
